          ...
          <ul>
            <li class="languages"><a href="#"><img src="/frontend/assets\img\logo\fontlogo.jpg" alt=""> English <i class="fa fa-angle-down"></i></a>
              <ul class="dropdown_languages">
                <li><a href="#"><img src="/frontend/assets\img\logo\fontlogo.jpg" alt=""> English</a></li>
                <li><a href="#"><img src="/frontend/assets\img\logo\fontlogo2.jpg" alt=""> French </a></li>
              </ul>
            </li>
  ...
  <div class="header_middel">
    <div class="row align-items-center">
      ...
      <div class="col-lg-3 col-md-3">
        <div class="logo">
          <a href="index.html"><img src="/frontend/assets\img\logo\logo.jpg.png" alt=""></a>
        </div>
      </div>
      <!--logo end-->
